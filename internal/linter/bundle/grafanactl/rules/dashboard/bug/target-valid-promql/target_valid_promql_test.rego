package grafanactl.rules.dashboard.bug["target-valid-promql_test"]

import data.grafanactl.utils

import data.grafanactl.rules.dashboard.bug["target-valid-promql"] as rule
...
test_dashboard_v1_with_invalid_panel if {
	...
	assert_reports_match(report, {{
		...
		"related_resources": [{"description": "documentation", "ref": "https://github.com/grafana/dashboard-linter/blob/main/docs/rules/target-promql-rule.md"}],
