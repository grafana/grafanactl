package grafanactl.rules.dashboard.idiomatic["panel-units_test"]

import data.grafanactl.utils

import data.grafanactl.rules.dashboard.idiomatic["panel-units"] as rule
...
test_dashboard_v1_with_invalid_unit if {
	...
	assert_reports_match(report, {{
		...
		"related_resources": [{"description": "documentation", "ref": "https://github.com/grafana/dashboard-linter/blob/main/docs/rules/panel-units-rule.md"}],
