package grafanactl.rules.dashboard.idiomatic["panel-title-description_test"]

import data.grafanactl.utils

import data.grafanactl.rules.dashboard.idiomatic["panel-title-description"] as rule
...
test_dashboard_v1_with_no_title_description if {
	...
	assert_reports_match(report, {{
		...
		"related_resources": [{"description": "documentation", "ref": "https://github.com/grafana/dashboard-linter/blob/main/docs/rules/panel-title-description-rule.md"}],
